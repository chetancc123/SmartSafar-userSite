...
export default function Transport2() {
  ...
  const [homeReceiver, setHomeType] = useState('');
  ...
  const handleConfirm = async () => {
    ...
    try {
      await AsyncStorage.setItem('homeReceiver', homeReceiver);
      await AsyncStorage.setItem('receiverName', receiverName);
      await AsyncStorage.setItem('receiverMobile', receiverMobile);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={styles.confirmButton}>
        <Text style={styles.confirmButtonText} onPress={handleConfirm}>Confirm</Text>
      </TouchableOpacity>
